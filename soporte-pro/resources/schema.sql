...
INSERT INTO cliente (rut, nombre, apellido, correo) VALUES
('11111111-1', 'Juan', 'Perez', 'juan.perez@mail.com'),
('22222222-2', 'María', 'Gonzalez', 'maria.gonzalez@mail.com'),
('33333333-3', 'Luiz', 'Ramirez', 'luiz.ramirez@mail.com');

INSERT INTO empleado (rut, nombre, apellido, correo) VALUES
('44444444-4', 'Ana', 'Lopez', 'ana.lopez@mail.com'),
('55555555-5', 'Pedro', 'Sanchez', 'pedro.sanchez@mail.com');
